...
router.get("/", function (req, res, next) {
  ...
  let count =
    req.query.count == null || req.query.count == "" ? 15 : req.query.count;
  let offset =
    req.query.offset == null || req.query.offset == "" ? 0 : req.query.offset;
  let isRandom =
    req.query.random == null || req.query.random == ""
      ? false
      : req.query.random;
  let lang =
  ...
  if (isRandom == "true") {
    try {
      quotes = quotesManager.getQuotesRandom(
        authors,
        sources,
        query,
        count,
